...
class Automation:
    ...
    async def start_actions(self) -> None:
        try:
            ...
            await self.search_item(title=self.title, url=self.url)
            ...
            for action in self.get_random_actions():
                try:
                    ...
                    logger.error(
                        f"Error while doing action: {action.__name__}: {error}"
                    )
    ...
    async def close_modal_dialog(
        self, accept_button_selector: str = "#js-first-screen-accept-all-button"
    ) -> None:
        """Close modal dialog by clicking on accept button."""
        try:
            element = await self.page.wait_for_selector(
                accept_button_selector, timeout=3000
            )
    ...
    async def select_page_language_and_country(
        ...
        try:
            element = await self.page.wait_for_selector(
                continue_button_selector, timeout=3000
            )
            await element.click(delay=2000)
            await self.random_sleep()
    ...
    async def search_item(
        ...
        try:
            element = await self.page.wait_for_selector(
                search_input_selector, timeout=3000
            )
            await element.click(delay=2000)
    ...
    async def click_product_if_match(
        self, products: list[tuple[str, async_api.ElementHandle]], url: str
    ):
        for el_url, product in products:
            if url == el_url:
                try:
                    ...
                    logger.error(
                        f"Error while clicking on product element, going to page directly"
                    )
                    await self.page.goto(url, wait_until="load")
    ...
    async def show_more_reviews(
        ...
        try:
            reviews_count = 0
            while (
                await self.page.is_visible(show_more_button_selector, timeout=3000)
                and reviews_count < max_reviews
            ):
                element = await self.page.wait_for_selector(
                    show_more_button_selector, timeout=3000
                )
                await element.scroll_into_view_if_needed()
                await element.click(delay=2000)
        ...
        try:
            ...
            for product in products:
                products_links.append(
                    (
                        str(
                            f'https://www.bol.com{await product.get_attribute("href")}'
                        ),
                        product,
                    )
                )
    ...
    async def share_product(
        ...
        try:
            element = await self.page.wait_for_selector(
                share_button_selector, timeout=3000
            )
            await element.scroll_into_view_if_needed()
            await element.click(delay=2000)
    ...
    async def add_product_to_wishlist(
        ...
        try:
            ...
            element = await self.page.wait_for_selector(
                wishlist_button_selector, timeout=3000
            )
            await element.scroll_into_view_if_needed()
            await element.click(delay=2000)
    ...
    async def delete_product_from_wishlist(
        ...
        try:
            element = await self.page.wait_for_selector(
                delete_button_selector, timeout=3000
            )
            await element.scroll_into_view_if_needed(timeout=3000)
            await element.click(delay=2000)
    ...
    async def product_specification(
        ...
        try:
            element = await self.page.wait_for_selector(
                specification_selector, timeout=3000
            )
            await element.scroll_into_view_if_needed()
            await element.click(delay=2000)
            ...
            await self.random_sleep()
            await self.scroll_page(
                x=random.randint(100, 300), y=random.randint(300, 800)
            )
            ...
            try:
                ...
                try:
                    element = await self.page.wait_for_selector(
                        show_less_button_selector, timeout=3000
                    )
                    await element.scroll_into_view_if_needed()
                    await element.click(delay=2000)
    ...
    async def compare_with_others_items(
        ...
        try:
            ...
            element = await self.page.wait_for_selector(
                compare_button_selector, timeout=3000
            )
            await element.scroll_into_view_if_needed(timeout=3000)
            await element.click(delay=2000)
            await self.random_sleep()
    ...
    async def scroll_images_carousel(
        ...
        try:
            element = await self.page.wait_for_selector(
                carousel_next_selector, timeout=3000
            )
            await element.scroll_into_view_if_needed()
            await element.click(delay=2000)
            ...
            try:
                element = await self.page.wait_for_selector(
                    carousel_prev_selector, timeout=3000
                )
                await element.click(delay=2000)
                await self.random_sleep()
                # await self.dynamic_scroll()
